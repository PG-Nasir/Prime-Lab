												...
												<table class="table table-hover table-bordered table-sm">
													<thead>
														<tr>
															...
															<th class="text-center">Refund <input
																class="checkItem" type="checkbox" id="checkAllRefund"></i></th>
															<th class="text-center">Discount <input
																class="checkItem" type="checkbox" id="checkAllDiscount"></i></th>
