				...
				<div class="row">
						...
						<table align="center">
							<tr>
								...
								<td>  <button type="submit" onclick="labsalestatementreport()" class="btn btn-info">Submit</button></div></td>
							</tr>
								...
								<div class="card-box">
									<div class="card-block">
										...
										<div class="card-header text-center">
									        ...
									        <h1 class="card-title text-bold">Lab Sales Statement For <span id='startdatep'>2020-05-15</span> To <span id='enddatep'>2020-05-15</span></h1>
										...
										<table class="table table-stripped">
											...
											<tbody id="labsalesstatement_table">
