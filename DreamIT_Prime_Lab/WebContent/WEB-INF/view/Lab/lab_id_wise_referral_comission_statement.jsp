...
<div class="page-content">
	...
	<div class="card-box pt-2 pb-1">
		<header class="">
			<h5 class="text-center" style="display: inline;">Lab Id Wise Referral Commission Statement Summary</h5>
		</header>
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<button class="btn btn-sm btn-success mt-3 border"
						data-toggle="modal" onclick="LabIdWiseReferralCommissionStatementPreview()">
