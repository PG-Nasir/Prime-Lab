...
<div class="page-content-wrapper">
	...
	<div class="card-box pt-2 pb-1">
		<header class="">
			<h5 class="text-center" style="display: inline;">Lab Sale Statement</h5>
		</header>
		...
		<div style="background-color: #89CFF0" class="card-box pt-1 pb-1 mb-1">
			<div class="row">
				...
				<div class="col-sm-2 mr-1">
					<label for="type" class="mb-0">Report Type</label>
					<div class="row">
				...
				<div class="col-sm-3">
					<button class="btn btn-sm btn-success mt-3 border"
						data-toggle="modal" onclick="labSaleStatementPreview()">
