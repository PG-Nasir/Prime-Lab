...
<jsp:include page="../include/header.jsp" />
 ...
 <body onload="LabReportTitleList()">
				...
				<div class="card-box">
					<div class="row">
						<div class="col-sm-5 col-md-5 col-lg-5">
							...
							<div class="form-group mb-0">
								<label class="mb-0">Title Name</label>
								
								<textarea class="form-control" id="titleName" rows="3"></textarea>
						...
						<div class="col-sm-7 col-md-7 col-lg-7 shadow ">
							<div class="input-group my-2">
								<input type="text" class="form-control"
									placeholder="Search Report Title" aria-describedby="findButton"
...
<script
	src="${pageContext.request.contextPath}/assets/js/lab/lab-report-title-create.js"></script>
