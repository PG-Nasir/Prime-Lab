...
List<OrganizationInfo> orgranizationInfo = (List<OrganizationInfo>) session.getAttribute("organization_info");
    ...
    try {
		...
		System.out.println("toDate "+toDate);
			...
			String Sql="select *,(select organizationLogo from tbOrganizationInfo where organizationId='1' ) as OrgLogo from TbLabSaleDueReceivedStatement('"+starDate+"','"+toDate+"','"+fromDate+"') where PatientType='"+patientType+"' order by UserName,DateOfBill,BillStatus";
	    	System.out.println("Query "+Sql);
	    	
	        
			String jrxmlFile = session.getServletContext().getRealPath("WEB-INF/jasper/lab/LabDueReceiveStatement.jrxml");
