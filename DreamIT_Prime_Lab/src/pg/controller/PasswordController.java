...
@Controller
@SessionAttributes({"userId","userName","organization_info","storelist","warelist","modulelist","menulist"})
...
public class PasswordController {
	...
	public String login(@RequestParam String softwarePaymentStatus,@RequestParam String name,@RequestParam String password,HttpServletRequest request,ModelMap modelmap) 	
	{	
		...
		System.out.println("softwarePaymentStatus "+softwarePaymentStatus);
		
		if(softwarePaymentStatus.equalsIgnoreCase("Paid")) {
			if(lg.size()>0) {
	...
	public String adminDashboard(ModelMap modelmap,HttpServletRequest request,HttpSession sessionnew)  {
