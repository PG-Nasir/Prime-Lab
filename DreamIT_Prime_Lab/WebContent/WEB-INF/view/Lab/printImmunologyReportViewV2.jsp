...
String titleId = (String)request.getAttribute("titleId"); 
    ...
    try {
		...
		String jrxmlFile=session.getServletContext().getRealPath("WEB-INF/jasper/LabResultReport/ImmunologyConfirmatoryReport.jrxml");
