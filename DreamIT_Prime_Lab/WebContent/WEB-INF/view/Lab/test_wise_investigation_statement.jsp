...
<div class="page-content">
	...
	<div class="card-box pt-2 pb-1">
		<header class="">
			<h5 class="text-center" style="display: inline;">Test wise lab sale statement</h5>
		</header>
		...
		<div style="background-color: #89CFF0" class="card-box pt-1 pb-1 mb-1">
			<div class="row">
				...
				<div class="col-sm-4 mr-1">
					<label for="type" class="mb-0">Test Name</label>
					<div class="row">
								<select
				...
				<div class="col-sm-2">
					<button class="btn btn-sm btn-success mt-3 border"
						data-toggle="modal" onclick="testWiseInvestigationStatementPreview()">
