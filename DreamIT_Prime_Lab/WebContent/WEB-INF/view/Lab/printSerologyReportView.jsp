...
<%
    ...
    try {
		...
		for(Iterator<?> iter = tlist.iterator(); iter.hasNext();)
		{
			...
			normalRange=element[3].toString();
		...
		if(normalRange.equals("")){
			jrxmlFile=session.getServletContext().getRealPath("WEB-INF/jasper/LabResultReport/Serology2Col.jrxml");
		}
		else{
			jrxmlFile=session.getServletContext().getRealPath("WEB-INF/jasper/LabResultReport/Serology3Col.jrxml");
		}
